...
In case this error is unexpected for you, please report it in https://pris.ly/prisma-prisma-bug-report`
    ...
    exports.Prisma.AccessSearchFormScalarFieldEnum = {
      id: "id",
      roleId: "roleId",
      formId: "formId",
      accessType: "accessType"
    ...
    exports.Prisma.InputFieldScalarFieldEnum = {
      id: "id",
      pos: "pos",
      colSpan: "colSpan",
      colStart: "colStart",
    ...
    exports.Prisma.ReportColScalarFieldEnum = {
      id: "id",
      pos: "pos",
      reportId: "reportId",
      queryId: "queryId"
    };
    exports.Prisma.ReportRowScalarFieldEnum = {
      id: "id",
      pos: "pos",
      colId: "colId",
      queryId: "queryId"
    ...
    exports.Prisma.ValListScalarFieldEnum = {
      id: "id",
      condId: "condId",
      value: "value"
    };
    ...
    exports.Prisma.ModelName = {
      ...
      Role: "Role",
      AccessInputForm: "AccessInputForm",
      AccessSearchForm: "AccessSearchForm",
      UserRole: "UserRole",
      User: "User",
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/UI/elements/error_message.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709722332690.209";
}
var {
  Alert
...
function ErrorMessage({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Alert, { className: "text-white bg-red-500", open: errors !== void 0, onClose: () => setOpen(false), children: errors ? errors : "" }, void 0, false, {
    fileName: "app/components/UI/elements/error_message.tsx",
    lineNumber: 32,
    columnNumber: 10
  }, this);
}
_s(ErrorMessage, "xG1TONbKtDWtdOTrXaTAsNhPg/Q=");
_c = ErrorMessage;
var _c;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/UI/elements/panel.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1709101911551.432";
}
function Panel({
  className,
  children,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: `${className} bg-white border p-1 shadow-blue-gray-700 shadow-md`, ...props, children }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/UI/elements/custom_button.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
